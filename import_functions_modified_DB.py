...
log_file = codecs.open(log_path + "log_test_import_functions_modified_DB.txt", 'a', encoding='utf-8')
...
def sync_md5_table(DB_conn, csv_path = ""):
    ...
    try:
        ...
        query = "SELECT base.id, base.mail FROM base LEFT JOIN md5 ON base.id = md5.mail_id WHERE md5.mail_id is NULL;"
...
def clean_data(dataframe, field):
    cleaning_scripts = {'prenom' : clean_name, 'nom' : clean_name, 'cp' : clean_cp, \
                        ...
                        'port' : clean_port, 'tel' : clean_tel, 'fax' : clean_tel, \
